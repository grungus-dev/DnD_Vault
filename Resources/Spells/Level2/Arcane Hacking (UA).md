...
This spell also allows you to break 2nd level and lower protective spells such as [Arcane Lock](Arcane Lock) or [Glyph of Warding](Glyph of Warding) by making an Intelligence check using hacking tools against the spell save DC of the spell's caster.
...
***Spell Lists.*** [Sorcerer](Sorcerer.md), [Warlock](Warlock.md), [Wizard](Wizard.md)