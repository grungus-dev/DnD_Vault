...
You can issue any command you choose, short of an activity that would result in certain death. Should you issue a suicidal command, the spell ends. You can end the spell early by using an action to dismiss it. A [Remove Curse](Remove Curse), [Greater Restoration](Greater Restoration), or [Wish](Wish) spell also ends it.

***At Higher Levels.*** When you cast this spell using a spell slot of 7th or 8th level, the duration is 1 year. When you cast this spell using a spell slot of 9th level, the spell lasts until it is ended by one of the spells mentioned above.

***Spell Lists.*** [Bard](Resources/Classes/Bard.md), [Cleric](Cleric.md), [Druid](Druid.md), [Paladin](Paladin), [Wizard](Wizard.md)